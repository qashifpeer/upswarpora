...
<div class="overflow-x-auto relative">
    ...
    <div class="flex justify-center py-4">
        ...
        <div><a href=""><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Marks-Sheet</button>
        </a></div>
    </div>
</div>
