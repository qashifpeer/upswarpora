        ...
        <div class="bg-white  rounded-lg md:w-1/2">
            ...
            <div class="flex flex-col items-center justify-center pt-10">
                <div class="flex flex-col relative mb-10">
                    <svg xmlns="http://www.w3.org/2000/svg" xlink:href="data:image/png;base64 viewBox="0 0 1440 320">
                    ...
                    <img src="{{ asset('img/me.jpg') }}" alt=""
                        class="w-24 h-24 absolute rounded-full top-24 shadow-xl left-20">
                </div>
