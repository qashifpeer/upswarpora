    ...
    <div class="border  border-gray-700 ">
        <div class="mx-auto">
            @if (Session::has('error'))
                <div class="text-red-900 text-lg bg-green-400 text-center" role="alert">
                    {{ session::get('error') }}
                </div>
            @endif
        </div>
        <form action="{{ url('/admin/added-student') }}" method="POST">
            ...
            <div class="mx-auto p-5 md:px-36 space-y-2">
                ...
                <div>
                    ...
                    @error('enr_number')
                        <div class="text-sm text-red-900">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div>
                    <label for="father_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Father's
                        name</label>
                ...
                <div>
                    <label for="mother_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mother's Name</label>
